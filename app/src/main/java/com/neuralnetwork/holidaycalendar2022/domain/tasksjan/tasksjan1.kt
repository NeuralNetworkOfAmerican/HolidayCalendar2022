...
class tasksjan1: AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        myDbManagerJan1.openDb()
        val dataList = myDbManagerJan1.readDbData()
    ...
    fun onClickSave(view: android.view.View) {
        myDbManagerJan1.openDb()
        myDbManagerJan1.clearDb()
        myDbManagerJan1.insertToDb(edTitle.text.toString())
    }
